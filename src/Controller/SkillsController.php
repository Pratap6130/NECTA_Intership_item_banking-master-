...
class SkillsController extends AppController
{
    ...
    {
        $skill = $this->Skills->get($id, contain: ['SkillLevels', 'Items']);
    ...
    public function add()
    {
        ...
        $skillLevels = $this->Skills->SkillLevels->find('list', limit: 200)->all();
        $this->set(compact('skill', 'skillLevels'));
    }
    ...
    {
        $skill = $this->Skills->get($id, contain: []);
